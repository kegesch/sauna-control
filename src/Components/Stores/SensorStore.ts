...
export default class SensorStore {
    ...
    constructor(
        ...
        this.temperatureService.temperature$.subscribe({
            error: () => console.error("Could not retrieve temperature from TemperatureService."),
        ...
        sensorService.evaporating$.subscribe({
            error: () => console.error("Could not retrieve evaporating from SensorService."),
