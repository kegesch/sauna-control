...
@observer
export default class SystemScreen extends React.Component<ISystemScreenProps, {}> {
    ...
    public render() {
        return (
            <div>
                ...
                <TempInfo><Icon name="mapmarker" size={70} color={MaterialColors.white} />{this.props.weatherStore.currentTemp}°C</TempInfo>
            </div>
        );
