...
@inject("musicStore")
@observer
export default class MusicScreen extends React.Component<IMusicScreenProperties, {}> {
    ...
    public render() {
        ...
        for (let i = 0; i < music1.length; i++) {
            const row = <tr><td className="musicColumnLeft">{music1[i].getName()}</td><td className="musicColumnRight">{music2[i].getName()}</td></tr>;
            musicRows.push(row);
        }
